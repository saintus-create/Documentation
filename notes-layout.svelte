<script lang="ts">
	// Notes Layout - Place this in your routes folder as +layout.svelte
	// Example: src/routes/notes/+layout.svelte
	
	import NotesSidebar from "./notes-sidebar.svelte";
	import * as Sidebar from "$lib/registry/ui/sidebar/index.js";
	import { notesSidebarNavItems } from "./notes-navigation.js";
...
<div class="container-wrapper flex flex-1 flex-col px-2">
	...
	>
		<NotesSidebar navItems={notesSidebarNavItems} />
