<script lang="ts">
	...
	// This is a simplified version adapted from the docs-sidebar
	// You'll need to have the Sidebar component from shadcn-svelte installed
	// Run: npx shadcn-svelte@latest add sidebar
	
	import * as Sidebar from "$lib/registry/ui/sidebar/index.js";
	import { page } from "$app/state";
	import type { NotesSidebarNavItem } from "./notes-navigation.js";
	import type { ComponentProps } from "svelte";

	let {
		navItems,
		...restProps
	}: { navItems: NotesSidebarNavItem[] } & ComponentProps<typeof Sidebar.Root> = $props();
												...
												<a href={subItem.href} {...props}>
													...
													{#if subItem.indicator === "new"}
														<span
															...
															title="New"
														></span>
													{:else if subItem.indicator === "updated"}
														<span
